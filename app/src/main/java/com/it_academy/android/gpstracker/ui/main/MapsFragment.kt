...
import com.it_academy.android.gpstracker.LocationForegroundService
import com.it_academy.android.gpstracker.R
import com.it_academy.android.gpstracker.databinding.FragmentMapsBinding
import com.it_academy.android.gpstracker.utils.factory
...
class MapsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mapCover.setOnTouchListener { v, event ->
    ...
    private fun initObservers() {
        viewModel.showDialog.observe(viewLifecycleOwner, Observer {
            AlertDialog.Builder(requireContext()).setMessage("Дай добро!")
